...
- If a dependency or package file is required for the technology (for example, package.json for Node.js, .csproj for C#, or pom.xml for Java), generate that file as one of the code blocks. Ensure the file includes all necessary dependencies with their explicit version numbers.
